...
class Generator(chainer.Chain):
    def __init__(self):
        super(Generator, self).__init__(
            l0z = chainer.links.Linear(100, 6*6*512, wscale=0.02*math.sqrt(100)),
    ...
    def __call__(self, z, test=False):
        h = chainer.functions.reshape(chainer.functions.relu(self.bn0l(self.l0z(z), test=test)), (z.data.shape[0], 512, 6, 6))
